...
import { ListenConfig, DispatchConfig, HookConfig } from './Modal.ElementConfig'
...
function ItemRender(props) {
  ...
  const handleMouseover = () => {
    setHover(true)
    Imitation.assignState({ modalContent: only })
  }
  const handleMouseout = () => {
    setHover(false)
    Imitation.assignState({ modalContent: undefined })
  }
