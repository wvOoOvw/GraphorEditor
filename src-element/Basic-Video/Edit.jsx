...
function Edit(props) {
  ...
  return <Grid container spacing={2}>
    <Grid item xs={12}>
      <TextField fullWidth label='视频地址' value={value.src} onChange={e => onChange(Object.assign({}, value, { src: e.target.value }))} multiline maxRows={4} />
    </Grid>
    <Grid item xs={12}>
      <TextField fullWidth label='封面地址' value={value.poster} onChange={e => onChange(Object.assign({}, value, { poster: e.target.value }))} multiline maxRows={4} />
    </Grid>
